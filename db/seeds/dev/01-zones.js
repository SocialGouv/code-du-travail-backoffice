exports.seed = async knex => {
  ...
  const suiGenerisCollectivities = [
    { category: 'sui_generis_collectivity', code: 'SGCNC', name: `Nouvelle-Calédonie` },
  ]

  await knex('api.zones').insert(suiGenerisCollectivities)

  const overseasCollectivities = [
    { category: 'overseas_collectivity', code: 'OC975', name: `Saint-Pierre-et-Miquelon` },
    { category: 'overseas_collectivity', code: 'OC977', name: `Saint-Barthélemy` },
    { category: 'overseas_collectivity', code: 'OC978', name: `Saint-Martin` },
    { category: 'overseas_collectivity', code: 'OC986', name: `Wallis-et-Futuna` },
    { category: 'overseas_collectivity', code: 'OC987', name: `Polynésie française` },
  ]

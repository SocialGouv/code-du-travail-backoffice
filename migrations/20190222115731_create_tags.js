exports.up = async knex => {
  ...
  await knex.raw('GRANT SELECT ON questions_tags TO anonymous')
  await knex.raw('GRANT SELECT ON answers_tags TO anonymous')
  await knex.raw('GRANT SELECT ON api.tags TO contributor')
  await knex.raw('GRANT SELECT, INSERT, UPDATE, DELETE ON questions_tags TO contributor')
  await knex.raw('GRANT SELECT, INSERT, UPDATE, DELETE ON answers_tags TO contributor')
...
exports.down = async knex => {
  ...
  await knex.raw('REVOKE SELECT ON questions_tags FROM anonymous')
  await knex.raw('REVOKE SELECT ON answers_tags FROM anonymous')
  await knex.raw('REVOKE SELECT ON api.tags FROM contributor')
  await knex.raw('REVOKE SELECT, INSERT, UPDATE, DELETE ON questions_tags FROM contributor')
  await knex.raw('REVOKE SELECT, INSERT, UPDATE, DELETE ON answers_tags FROM contributor')

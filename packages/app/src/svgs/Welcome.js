...
const WelcomeSvg = () => (
  <svg viewBox="0 0 1155.41 796.48">
    ...
    <path
      ...
      transform="translate(-22.3 -51.76)"
    />
    <ellipse cx="985.23" cy="791.38" fill="#6c63ff" opacity="0.1" rx="29.92" ry="5.06" />
    <path
      ...
      transform="translate(-22.3 -51.76)"
    />
    <ellipse cx="1079.04" cy="697.06" fill="#6c63ff" opacity="0.1" rx="16.87" ry="2.85" />
    <path
      ...
      transform="translate(-22.3 -51.76)"
    />
    <ellipse cx="934.94" cy="715.91" fill="#6c63ff" opacity="0.1" rx="20.37" ry="3.44" />
    <path
    ...
    <path
      ...
      transform="translate(-22.3 -51.76)"
    />
    <path d="M955.5,576.89" fill="none" transform="translate(-22.3 -51.76)" />
    <g opacity="0.1">
      <path
    ...
    <path
      ...
      transform="translate(-22.3 -51.76)"
    />
    <ellipse cx="157.52" cy="740.06" fill="#6c63ff" opacity="0.1" rx="62.19" ry="9.54" />
    <path
